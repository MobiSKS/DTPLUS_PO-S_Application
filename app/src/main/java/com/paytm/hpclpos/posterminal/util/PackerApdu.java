...
class PackerApdu implements IApdu {
    ...
    @Override
    public IApduReq createReq(byte cla, byte ins, byte p1, byte p2, byte lc) {
        return new ApduReq(cla, ins, p1, p2,lc);
    }

    @Override
    public IApduReq createReq(byte cla, byte ins, byte p1, byte p2, byte lc, byte[] data) {
        return new ApduReq(cla, ins, p1, p2,lc,data);
    }
    ...
    private class ApduReq implements IApduReq {
        ...
        public ApduReq(byte cla, byte ins, byte p1, byte p2,byte lc) {
            CLA = cla;
            INS = ins;
            P1 = p1;
            P2 = p2;
        ...
        public ApduReq(byte cla, byte ins, byte p1, byte p2, byte lc,byte[] data) {
            CLA = cla;
            INS = ins;
            P1 = p1;
            P2 = p2;
