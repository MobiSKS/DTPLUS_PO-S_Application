...
public class Convert{
    ...
    private String nullArgs = "longToByteArray input arg is null";
    private String nullShortArgs = "shortToByteArray input arg is null";
    private String nullAmtArgs = "amountMajorToMinUnit input arg is null";
    ...
    public void longToByteArray(long l, byte[] to, int offset, EEndian endian) throws IllegalArgumentException {
        if (to == null || endian == null) {
            Log.e(TAG, nullArgs);
            throw new IllegalArgumentException(nullArgs);
        }
    ...
    public void shortToByteArray(short s, byte[] to, int offset, EEndian endian) throws IllegalArgumentException {
        if (to == null || endian == null) {
            Log.e(TAG, nullShortArgs);
            throw new IllegalArgumentException(nullShortArgs);
        }
    ...
    public String amountMajorToMinUnit(double major, ECurrencyExponent exponent) throws IllegalArgumentException {
        if (exponent == null) {
            Log.e(TAG, nullAmtArgs);
            throw new IllegalArgumentException(nullAmtArgs);
        }
    ...
    public String amountMinUnitToMajor(String minUnit, ECurrencyExponent exponent, boolean isCommaStyle)
        ...
        if (isCommaStyle == true) {
            ...
            String str2 = "";
            int size = (temp.length() % 3 == 0) ? (temp.length() / 3) : (temp.length() / 3 + 1);
