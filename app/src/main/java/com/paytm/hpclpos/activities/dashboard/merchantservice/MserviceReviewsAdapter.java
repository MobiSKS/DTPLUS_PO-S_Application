...
public class MserviceReviewsAdapter  extends RecyclerView.Adapter<MserviceReviewsAdapter.HomeProfile>{
    ...
    public MserviceReviewsAdapter(Activity context, List<CardedAndMobileModel> cardedAndMobileModelList,FragmentActivity dashboardMerchantService) {
    ...
    @NonNull
    @Override
    public MserviceReviewsAdapter.HomeProfile onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_transaction_adapter, parent, false);
        return new MserviceReviewsAdapter.HomeProfile(view);
    }

    @Override
    public void onBindViewHolder(@NonNull MserviceReviewsAdapter.HomeProfile holder, int position) {
