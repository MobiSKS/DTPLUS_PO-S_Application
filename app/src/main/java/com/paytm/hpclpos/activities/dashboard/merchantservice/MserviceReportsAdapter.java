...
public class MserviceReportsAdapter extends RecyclerView.Adapter<MserviceReportsAdapter.HomeProfile>{

    FragmentActivity dashboardMerchantService;
    Activity context;
    private List<CardedAndMobileModel> cardedAndMobileModelList;

    public MserviceReportsAdapter(Activity context, List<CardedAndMobileModel> cardedAndMobileModelList,FragmentActivity dashboardMerchantService) {
    ...
    @NonNull
    @Override
    public MserviceReportsAdapter.HomeProfile onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_transaction_adapter, parent, false);
        return new MserviceReportsAdapter.HomeProfile(view);
    }
